...
This repository contains no application code. It is a taxonomy of category names, descriptions, and structure, so the
realistic risk is a **listed link becoming dangerous** rather than a vulnerability in
anything we ship.

## What to report

Please tell us if a category listed here:
